...
export const Items = Object.freeze({
    ...
    lava_bucket: {
        name: "Lava Bucket",
        id: "lava_bucket",
        ingredients: [{ id: "bucket", quantity: 1 }, {id: "lava", quantity: 1}],
        result: 1,
    },
    lava_cauldron: {
        name: "Lava Cauldron",
    ...
    water_bucket: {
        name: "Water Bucket",
        id: "water_bucket",
        ingredients: [{ id: "bucket", quantity: 1 }, {id: "water", quantity: 1}],
        result: 1,
    },
    water_cauldron: {
        name: "Water Cauldron",
        id: "water_cauldron",
        ingredients: [{ id: "cauldron", quantity: 1 }, {id: "water_bucket", quantity: 1}],
        result: 1,
    },
    waxed_copper_block: {
