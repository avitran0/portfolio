...
* @returns {Map<any, any>}
*/
export function get_litematica_blocks(data, bits_per_block, length) {
    const ptr0 = passArray64ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_litematica_blocks(ptr0, len0, bits_per_block, length);
...
* @returns {Map<any, any>}
*/
export function get_schematica_blocks(data, length) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_schematica_blocks(ptr0, len0, length);
    return takeObject(ret);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('schematics_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
